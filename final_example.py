...
from sample_tent_dist import tent_pdf, sample_tent_dist, tent_pdf_parallel, sample_tent_dist_parallel
from sample_bimodal_dist import bimodal_pdf, sample_binomal_dist, bimodal_pdf_parallel, sample_binomal_dist_parallel
...
def estimate_f_parallel(pdf, sample_pdf, num_of_samples):
    # pdf returns the value of the pdf at parameter x
    # sample_pdf is used to sample from the pdf
...
if __name__ == '__main__':
    ...
    tent_distribution = (tent_pdf_parallel, sample_tent_dist_parallel)
    bimodal_distribution = (bimodal_pdf_parallel, sample_binomal_dist_parallel)
    ...
    for i in range(1, 626):
        ...
        uniform_pdf_wrapper = lambda s: estimate_f_parallel(*uniform_distribution, num_of_samples=s)
        ...
        tent_pdf_wrapper = lambda s: estimate_f_parallel(*tent_distribution, num_of_samples=s)
        ...
        bimodal_pdf_wrapper = lambda s: estimate_f_parallel(*bimodal_distribution, num_of_samples=s)
